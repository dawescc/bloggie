				...
				<span className='lg:hidden'>
					<div className='flex flex-col gap-6'>
						<div className='flex gap-4'>
							<div className='rounded-lg overflow-hidden w-1/3 aspect-square my-auto transition-all duration-700 ease-in-out border-zinc-200 dark:border-zinc-700 border'>
								<img
							...
							<div className='flex flex-col gap-4'>
								...
								<a
									href='https://dawes.cc'
									className='text-[1.5rem]/[1.5rem] font-light hover:underline'>
									dawes.cc
								</a>
						...
						<a
							href='/#feed'
							className='rounded-full p-3 mx-auto bg-sky-300 hover:bg-sky-400 cursor-pointer select-none border border-sky-500 text-sky-700 hover:text-sky-100
