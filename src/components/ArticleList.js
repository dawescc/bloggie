			...
			<ul className='w-full h-full'>
				{articles.map((article) => (
					<li
						...
						{article.pinned && (
							<span className='ml-2 mr-auto text-[0.75rem]/[1rem] text-zinc-500 dark:text-zinc-500 pt-1'>
								<span
									onClick={() => setSelectedTopic("pinned")}
									className='cursor-pointer flex justify-center items-center content-center gap-1 py-[0.125rem] px-1 border border-zinc-200 dark:border-zinc-700 rounded-md'>
									<i className='fa-solid fa-star '></i>
									<span>featured</span>
								</span>
							</span>
